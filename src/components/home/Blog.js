                ...
                <div className="blog__content">
                    <div className="card blog__card">
                        <div className="card-image">
                            <img src="image/blog_1.jpg" alt="blog" />
                            <Link to="" className="btn-floating halfway-fab waves-effect waves-light btn-large red"><i className="material-icons">link</i></Link>
                        </div>
                        <div className="card-content">
                            ...
                            <p className="blog__text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
                                 has been the industry's standard dummy text ever since the 1500s, when an unknown printer took Link galley of 
                    ...
                    <div className="card blog__card">
                        <div className="card-image">
                            <img src="image/blog_2.jpg" alt="blog" />
                            <Link to="" className="btn-floating halfway-fab waves-effect waves-light btn-large red"><i className="material-icons">link</i></Link>
                        </div>
                        <div className="card-content">
                            <span className="card-title">Here Are Some Of Best Online Shopping Sites For You In Europe.</span>
